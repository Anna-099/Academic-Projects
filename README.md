...
Applies generalized linear models to analyze cancer incidence data.
Techniques: GLM (Poisson / Binomial models)
Language: R
Libraries: ggplot2, MASS, dplyr

🌱 6. Thesis: Environmental Survey Analysis
File: codeR_thesis.r
